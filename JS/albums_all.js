import { getAccessToken } from './config.js'; // Mengimpor fungsi getAccessToken dari file config.js untuk mendapatkan token akses dari Spotify API
...
async function displayTopPopAlbums() {
    try {
        ...
        // Mendapatkan elemen HTML dengan id 'all-albums' untuk menampilkan album
        const albumsListDiv = document.getElementById('all-albums');
